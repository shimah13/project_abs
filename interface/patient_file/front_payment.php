...
$patdata = sqlQuery("SELECT " .
    "p.fname, p.mname, p.lname, p.pubpid,p.pid, i.copay, i.provider " .
    ...
    <div class="container mt-3"><!--begin container div for form-->
        ...
        <div class="row">
            <div class="col-sm-12">
				...
				$getPastEncounters = sqlStatement("SELECT GROUP_CONCAT(b.encounter) as encounter FROM billing b left join form_encounter fe on fe.encounter = b.encounter where b.pid = ? and DATE_FORMAT(fe.date, '%Y-%m-%d') < ? and b.activity != 0 group by b.encounter", [$_SESSION['pid'], date('Y-m-d')]);
