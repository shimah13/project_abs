...
//
function todaysEncounterCheck($patient_id, $enc_date = '', $reason = '', $fac_id = '', $billing_fac = '', $provider = '', $cat = '', $return_existing = true, $appt_id = '')
{
    global $today;
    ...
    addForm(
	    ...
	    "pos_code = ?, " . 
	    "appt_id = ?",
            array($dos,$visit_reason,$facility,$facility_id,$billing_facility,$visit_provider,$patient_id,$encounter,$visit_cat, $pos_code, $appt_id)
        ),
        "newpatient",
        $patient_id,
        "1",
